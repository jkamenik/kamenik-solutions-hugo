...
[RTK](https://www.rtk-ai.app/). (Rust Token Killer) is an open-source CLI proxy that compresses shell command output before it reaches an [[AI Agent]] context window, typically cutting token use by 60-90% with transparent hooks for [[Claude Code]], [[Cursor]], and other coding assistants.

...
[FrontEgg](https://frontegg.com/). Is a B2B **user-management** platform: embedded auth, tenant/org modeling, admin portals, roles, audit logs, and product-facing identity UX; not just OIDC plumbing.

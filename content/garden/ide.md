...
Agent integration: many IDEs now host models via built-in chat or [[Agent Client Protocol]]; skills follow [[Agent Skills]] when the runtime supports them. [[Dev Container]] often pairs with VS Code–class editors for reproducible dev environments.
